        ...
        <View className="bg-primary flex-1">
            ...
            contentContainerStyle={{
                ...
                <View className="flex-col items-start justify-center mt-5 px-5">
                    ...
                    <View className="flex-row items-center gap-x-1 mt-2 ml-2">
            ...
            <TouchableOpacity className="absolute bottom-5 left-5 right-5 bg-accent rounded-2xl py-3 flex-row items-center justify-center z-50" onPress={router.back}>
